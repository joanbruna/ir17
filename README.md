...
| 11 | 11/13 | **Lec8**  Variational Inference (cont'd). Variational Autoencoders | [Variational Inference: A review for Statisticians, by Blei, McAuliffe, Kucukelbir](https://arxiv.org/pdf/1601.00670.pdf) [AutoEncoding Variational Bayes (Kingma, Welling](https://arxiv.org/abs/1312.6114) | [PS5](https://github.com/inf17nyu/home/blob/master/hw/ps5/ps5.pdf), due 11/21 | 
